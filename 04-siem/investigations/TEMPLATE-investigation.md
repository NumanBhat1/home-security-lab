...
## 4. Recommendation / Containment
What would you tell the client / do next?
- e.g. block source IP, force password reset, isolate host, tune the rule to reduce noise.

## 5. Lessons / tuning
Did the rule need adjusting? Too noisy? Missed anything?
